...
**Date:** 2026-06-29 · **Framework:** SQGLP / six-pillar (quantitative proxy) · **Source:** screener.in
...
| **Thesis** | ROCE 21.8%, 35.1% earnings CAGR, Rs 2545 cr mcap |
...
|---|---|---|---|
| S — Size & obscurity | 15% | 84 | Mcap ≈ Rs 2545 cr → re-rating room scored 84. |
...
| P — Price | 10% | 82 | P/E 23.8, PEG 0.68 → 82. |
...
|---|---|---|---|---|
| Bear | 15.0% | 14.3x | 1.2x | 2.4x |
| Base | 30.0% | 23.8x | 3.7x | 13.8x |
| Bull | 35.0% | 35.7x | 6.7x | 30.2x |

*From current P/E 23.8 and ~35.1% historical earnings CAGR. Forward-looking and illustrative only.*
...
| **Thesis** | ROCE 25.8%, 15.6% earnings CAGR, Rs 6674 cr mcap |
...
| P — Price | 10% | 62 | P/E 20.1, PEG 1.29 → 62. |
...
| Scenario | EPS CAGR | Exit P/E | 5y multiple | 10y multiple |
|---|---|---|---|---|
| Bear | 7.8% | 12.1x | 0.9x | 1.3x |
| Base | 15.6% | 20.1x | 2.1x | 4.3x |
| Bull | 20.3% | 30.2x | 3.8x | 9.5x |

*From current P/E 20.1 and ~15.6% historical earnings CAGR. Forward-looking and illustrative only.*
...
| P — Price | 10% | 62 | P/E 30.3, PEG 1.07 → 62. |
...
| Base | 28.3% | 30.3x | 3.5x | 12.1x |
| Bull | 35.0% | 45x | 6.7x | 29.9x |

*From current P/E 30.3 and ~28.3% historical earnings CAGR. Forward-looking and illustrative only.*
...
| **Score** | **64.0 / 100** |
| **Classification** | Watchlist |
| **Thesis** | ROCE 17%, 23.5% earnings CAGR, Rs 1630 cr mcap |
...
| Pillar | Weight | Score | Justification |
|---|---|---|---|
| S — Size & obscurity | 15% | 84 | Mcap ≈ Rs 1630 cr → re-rating room scored 84. |
...
| P — Price | 10% | 62 | P/E 33.2, PEG 1.41 → 62. |
...
| Scenario | EPS CAGR | Exit P/E | 5y multiple | 10y multiple |
|---|---|---|---|---|
| Bear | 11.8% | 19.9x | 1.0x | 1.8x |
| Base | 23.5% | 33.2x | 2.9x | 8.3x |
| Bull | 30.6% | 45x | 5.1x | 19.5x |

*From current P/E 33.2 and ~23.5% historical earnings CAGR. Forward-looking and illustrative only.*
...
| **Thesis** | ROCE 16.4%, 7.2% earnings CAGR, Rs 987 cr mcap |
| **Top risk** | Hard flag: Share count CAGR ≤ 4% |
| **Hard flags** | 1 fired |
...
| Pillar | Weight | Score | Justification |
|---|---|---|---|
| S — Size & obscurity | 15% | 84 | Mcap ≈ Rs 987 cr → re-rating room scored 84. |
...
| P — Price | 10% | 22 | P/E 24, PEG 3.33 → 22. |
...
| Scenario | EPS CAGR | Exit P/E | 5y multiple | 10y multiple |
|---|---|---|---|---|
| Bear | 3.6% | 14.4x | 0.7x | 0.9x |
| Base | 7.2% | 24.0x | 1.4x | 2.0x |
| Bull | 9.4% | 36.0x | 2.3x | 3.7x |

*From current P/E 24 and ~7.2% historical earnings CAGR. Forward-looking and illustrative only.*
...
| **Thesis** | ROCE 59.2%, 23.3% earnings CAGR, Rs 33027 cr mcap |
| **Top risk** | Hard flag: Promoter stake ≥ 40% & stable |
| **Hard flags** | 2 fired |
...
| Pillar | Weight | Score | Justification |
|---|---|---|---|
| S — Size & obscurity | 15% | 40 | Mcap ≈ Rs 33027 cr → re-rating room scored 40. |
...
| P — Price | 10% | 18 | P/E 83.6, PEG 3.59 → 18. |
...
| Scenario | EPS CAGR | Exit P/E | 5y multiple | 10y multiple |
|---|---|---|---|---|
| Bear | 11.7% | 50.2x | 1.0x | 1.8x |
| Base | 23.3% | 83.6x | 2.8x | 8.1x |
| Bull | 30.3% | 45x | 2.0x | 7.6x |

*From current P/E 83.6 and ~23.3% historical earnings CAGR. Forward-looking and illustrative only.*
